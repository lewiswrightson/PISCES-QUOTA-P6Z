...
CONTAINS
   ...
   SUBROUTINE trc_nam_pisces
      ...
      !!
      NAMELIST/nampismod/ln_p2z, ln_p4z, ln_p5z, ln_ligand, ln_sediment, ln_p6z, ln_tricho
      !!----------------------------------------------------------------------
...
902   IF( ios >  0 )   CALL ctl_nam ( ios , 'nampismod in configuration namelist' )
      ...
      IF(lwp) THEN                  ! control print
         ...
         WRITE(numout,*) '      Flag to use PISCES quota explicit diazotrophy    ln_p6z      = ', ln_p6z
      ...
      IF(lwp) THEN                         ! control print
         ...
         IF( ln_tricho )  WRITE(numout,*) '   ==>>>   Tricho is used'
      ENDIF
