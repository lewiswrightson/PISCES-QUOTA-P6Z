...
CONTAINS
   ...
   SUBROUTINE trc_ini_pisces
      ...
      CALL trc_nam_pisces
      !
      IF( ln_p4z .OR. ln_p5z .OR. ln_p6z ) THEN  ;   CALL p4z_ini   !  PISCES
   ...
   SUBROUTINE p4z_ini
      ...
      IF( .NOT.ln_rsttr ) THEN  
         ...
         IF( ln_p6z ) THEN
            trn(:,:,:,jpcdz) = bioma0
            trn(:,:,:,jpfed) = bioma0 * 5.e-6
            trn(:,:,:,jpchd) = bioma0 * 12. / 55.
            trn(:,:,:,jpndz) = bioma0
            trn(:,:,:,jppdz) = bioma0
         ENDIF
      ...
      IF( ln_p6z ) THEN
         ...
         CALL p6z_prod_init      !  phytoplankton growth rate over the global ocean.
      ENDIF
