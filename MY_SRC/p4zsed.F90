MODULE p4zsed
   ...
   !! $Id: p4zsed.F90 13233 2020-07-02 18:34:16Z aumont $ 
...
CONTAINS
   ...
   SUBROUTINE p4z_sed( kt, knt )
      ...
      IF( ln_p5z .OR. ln_p6z )    ALLOCATE( ztrdop(jpi,jpj,jpk) )
...
!
      ...
      END DO
      !
      ! Loss of particulate organic N and P to the sediments (p5z and p6z)
      IF( ln_p5z .OR. ln_p6z) THEN
         DO jj = 1, jpj
            DO ji = 1, jpi
               ikt  = mbkt(ji,jj)
      ...
      IF( ln_p5z ) THEN 
        ! p5z
         ! PISCES-QUOTA part Implicit Nitrogen Fixation
         DO jk = 1, jpkm1
            DO jj = 1, jpj
               DO ji = 1, jpi
                  ! Potential nitrogen fixation dependant on temperature and iron
      ...
      IF( ln_p4z ) THEN
         ...
         END DO
      ENDIF
      IF( ln_p5z ) THEN    ! p5z implicit nitrogen fixation
         ! PISCES-QUOTA part
         DO jk = 1, jpkm1
            DO jj = 1, jpj
               DO ji = 1, jpi
      ...
      ENDIF
      !
      IF( ln_p5z .OR. ln_p6z)    DEALLOCATE( ztrpo4, ztrdop )
      !
